...
Front
The site is supposed to be anime themed interactive weathersite. Where the major feature is that when user searches for city the character
changes according to weather in that city. For example if in Oulu it is cold and snowing the character is shown in winter clothes with winter
background.
